            ...
            <div className='product-body'>
              <div>
                ...
                <div className='product-rating'>
                  {Array.from({length: itemData['rating']}).map( (_,index) => <FaStar className='star'/> )}
                  {(itemData['rating'] - Math.floor(itemData['rating']))? <FaStarHalf className='star'/>:<></>}
              ...
              <button className='gold-button product-button'>Add to cart</button>
            </div>
          </section>
        </div>
      </>
